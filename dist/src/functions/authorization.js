...
exports.validateState = exports.getAuthToken = exports.login = void 0;
var config_1 = require("../../config");
var axios_1 = __importDefault(require("axios"));
var url_1 = require("url");
var redirect_uri = "".concat(config_1.config.baseUrl, "/spotify-app-callback");
...
function validateState(client, state, sendLoadingMessageToClient) {
    if (!client) {
        var errorMessage = "Error(state_mismatch): no active client found with received state";
        console.log(errorMessage);
    }
    if (state !== client.state) {
        var errorMessage = "Error(state_mismatch): different state on client. Get outta here!";
        console.log(errorMessage);
